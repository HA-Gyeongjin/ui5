		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce25homework1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25homework1-display": {
								"semanticObject": "synce25homework1",
								"action": "display",
								"description": "UI5 – Table &amp; Fragment 활용하기",
								"title": "UI5 – Table &amp; Fragment 활용하기",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.homework1",
									"url": sap.ui.require.toUrl("sync/e25/homework1")
								}
							}
						}
					}
