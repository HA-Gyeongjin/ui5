					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제 E25",
									"targetURL": "#synce25ex3-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce25ex3-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.ex3",
									"url": sap.ui.require.toUrl("sync/e25/ex3")
								}
							}
						}
					}
