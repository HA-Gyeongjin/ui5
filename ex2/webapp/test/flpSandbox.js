					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제 E25",
									"targetURL": "#synce25ex2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce25ex2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.ex2",
									"url": sap.ui.require.toUrl("sync/e25/ex2")
								}
							}
						}
					}
