		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce25exercise13-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25exercise13-display": {
								"semanticObject": "synce25exercise13",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.exercise13",
									"url": sap.ui.require.toUrl("sync/e25/exercise13")
								}
							}
						}
					}
