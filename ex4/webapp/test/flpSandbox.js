					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 4번 문제 E25",
									"targetURL": "#synce25ex4-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce25ex4-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.ex4",
									"url": sap.ui.require.toUrl("sync/e25/ex4")
								}
							}
						}
					}
