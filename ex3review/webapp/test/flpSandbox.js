		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제리뷰 E25",
									"targetURL": "#synce25ex3review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25ex3review-display": {
								"semanticObject": "synce25ex3review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.ex3review",
									"url": sap.ui.require.toUrl("sync/e25/ex3review")
								}
							}
						}
					}
