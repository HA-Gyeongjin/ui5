sap.ui.define([
    ...
    function (Controller, Fragment) {
        ...
        return Controller.extend("sync.e25.ex3review.controller.Main", {
            onInit: function () {
                let data = {
                    Data: {
                        Carrid: "",
            ...
            openDialog: function() {
                ...
                if (oDialog) {
                    ...
                    Fragment.load({
                        id:oView.getId(),
                        name:'sync.e25.ex3review.view.New',
                        type: 'XML',
                        controller: this
            ...
            onSave: function () {
                ...
                // create( 경로(EntitySet), 신규데이터(Structure 구조), 결과처리 )
                oModel.create(
                    "/ConnectionSet",
                    newData,
