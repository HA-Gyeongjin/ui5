		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce25exercise8-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25exercise8-display": {
								"semanticObject": "synce25exercise8",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.exercise8",
									"url": sap.ui.require.toUrl("sync/e25/exercise8")
								}
							}
						}
					}
