					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "플렉서블 컬럼 레이아웃 연습(눈에 보이는 제목)",
									"targetURL": "#syncecfcl-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"syncecfcl-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ec.fcl",
									"url": sap.ui.require.toUrl("sync/ec/fcl")
								}
							}
						}
					}
