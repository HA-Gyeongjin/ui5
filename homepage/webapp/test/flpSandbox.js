		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "싱싱필 홈페이지",
									"targetURL": "#synczechomepage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczechomepage-display": {
								"semanticObject": "synczechomepage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zec.homepage",
									"url": sap.ui.require.toUrl("sync/zec/homepage")
								}
							}
						}
					}
