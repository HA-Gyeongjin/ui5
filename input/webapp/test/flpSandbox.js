		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "입력필드의 값 다뤄보기",
									"targetURL": "#synce25input-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25input-display": {
								"semanticObject": "synce25input",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.input",
									"url": sap.ui.require.toUrl("sync/e25/input")
								}
							}
						}
					}
