		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "다중 데이터 삭제",
									"targetURL": "#synce25odatamodelmultidelete-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25odatamodelmultidelete-display": {
								"semanticObject": "synce25odatamodelmultidelete",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.odatamodelmultidelete",
									"url": sap.ui.require.toUrl("sync/e25/odatamodelmultidelete")
								}
							}
						}
					}
