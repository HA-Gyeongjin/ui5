					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번 문제 E25",
									"targetURL": "#synce25ex1-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce25ex1-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.ex1",
									"url": sap.ui.require.toUrl("sync/e25/ex1")
								}
							}
						}
					}
