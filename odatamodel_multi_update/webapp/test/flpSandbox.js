		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce25odatamodelmultiupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25odatamodelmultiupdate-display": {
								"semanticObject": "synce25odatamodelmultiupdate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.odatamodelmultiupdate",
									"url": sap.ui.require.toUrl("sync/e25/odatamodelmultiupdate")
								}
							}
						}
					}
