		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "차트 연습",
									"targetURL": "#syncecvizframe-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncecvizframe-display": {
								"semanticObject": "syncecvizframe",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ec.vizframe",
									"url": sap.ui.require.toUrl("sync/ec/vizframe")
								}
							}
						}
					}
