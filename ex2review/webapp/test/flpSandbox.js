		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제리뷰 E25",
									"targetURL": "#synce25ex2review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25ex2review-display": {
								"semanticObject": "synce25ex2review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.ex2review",
									"url": sap.ui.require.toUrl("sync/e25/ex2review")
								}
							}
						}
					}
