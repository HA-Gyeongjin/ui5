		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce25odatamodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25odatamodel-display": {
								"semanticObject": "synce25odatamodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.odatamodel",
									"url": sap.ui.require.toUrl("sync/e25/odatamodel")
								}
							}
						}
					}
