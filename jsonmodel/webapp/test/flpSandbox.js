		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Model 연습",
									"targetURL": "#synce25jsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce25jsonmodel-display": {
								"semanticObject": "synce25jsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e25.jsonmodel",
									"url": sap.ui.require.toUrl("sync/e25/jsonmodel")
								}
							}
						}
					}
